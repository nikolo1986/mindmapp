...
1. Enter your Jira base URL (e.g. `https://yourcompany.atlassian.net`), choose Cloud (email + API token) or Server/Data Center (personal access token) auth, your credentials, and a project key, then click **Save & Test Connection**. The URL and credentials are whatever you type in — nothing is hardcoded to a particular Jira site.
